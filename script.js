...
const i18n = {
  es: {
    ...
    svc6_name:    'Diseño de Líneas',
    svc6_desc:    'Arte personalizado en cabello. Tu identidad, trazada con precisión.',
    ...
    ci_loc_val:   'Santo Domingo, República Dominicana',
    ci_hrs_lbl:   'Horario',
  ...
  en: {
    ...
    svc6_name:    'Line Design',
    svc6_desc:    'Custom line art in your hair. Your identity, etched with precision.',
    ...
    ci_wa_lbl:    'WhatsApp',
    ci_loc_lbl:   'Location',
    ci_loc_val:   'Santo Domingo, Dominican Republic',
    ci_hrs_lbl:   'Hours',
